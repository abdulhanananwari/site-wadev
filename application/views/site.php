...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('assets/img/wadev.jpg')">
  <div class="container">
    <div class="row">
      <div class="col-md-8 ml-auto mr-auto">
        <div class="brand text-center">
          <!-- <h1>wadev solution</h1>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="info">
                        ...
                        <h4 class="info-title">Custom App</h4>
